...
export const mangaData = [
  ...
  { "id": "t1", "title": "Two Heroes", "detail": "Two Heroes Novel", "type": "light novel", theme:"yellow" },
...
export const characterData = [
  {
    ...
    heroName: 'Deku',
    quirk: 'One For All',
    affiliation: 'U.A. High (Class 1-A)',
    birthday: 'July 15',
    height: '166 cm',
    bloodType: 'O',
    description: "A boy who was born without a Quirk in a world where they are the norm, but who still dreams of becoming a Hero. He inherited the power 'One For All' from the legendary hero All Might.",
    stats: { power: 'B', speed: 'B', technique: 'B', intelligence: 'A', cooperativeness: 'A' },
    civilianImage: 'https://i.ibb.co/kVYrQC60/Izuku-Midoriya-school-profile.webp',
    heroImage: 'https://i.ibb.co/kVfwwv7p/Izuku-Midoriya.png',
    color: 'text-green-400',
    sound: 'https://assets.mixkit.co/active_storage/sfx/1310/1310-preview.m4a',
    lightningColor: '#4ade80'
  },
  {
    id: 2,
    name: 'Katsuki Bakugo',
    ...
    height: '172 cm',
    bloodType: 'A',
    description: "Midoriya's childhood friend and rival. He has a very aggressive personality and a powerful Quirk that allows him to create explosions from his palms.",
    stats: { power: 'A', speed: 'A', technique: 'A', intelligence: 'A', cooperativeness: 'E' },
    civilianImage: 'https://i.ibb.co/0yXq2gq/Bakugo.png',
    heroImage: 'https://i.ibb.co/0yXq2gq/Bakugo.png',
    color: 'text-orange-500',
    sound: 'https://assets.mixkit.co/active_storage/sfx/1699/1699-preview.m4a',
  ...
  },
  {
    ...
    height: '176 cm',
    bloodType: 'O',
    description: "A student with a powerful Quirk that allows him to generate ice from his right side and fire from his left. He is the son of the No. 1 Hero, Endeavor.",
    stats: { power: 'A', speed: 'B', technique: 'A', intelligence: 'B', cooperativeness: 'C' },
    civilianImage: 'https://i.ibb.co/5Gz1X1d/Todoroki.png',
    heroImage: 'https://i.ibb.co/5Gz1X1d/Todoroki.png',
    color: 'text-cyan-400',
    sound: 'https://assets.mixkit.co/active_storage/sfx/1435/1435-preview.m4a',
    lightningColor: '#22d3ee'
  },
  {
    id: 4,
    name: 'Ochaco Uraraka',
    ...
    height: '156 cm',
    bloodType: 'B',
    description: "An outgoing and bubbly girl who helps Midoriya whenever she can. Her Quirk allows her to manipulate gravity, making objects weightless.",
    stats: { power: 'D', speed: 'C', technique: 'B', intelligence: 'B', cooperativeness: 'A' },
    civilianImage: 'https://i.ibb.co/7jXq2gq/Uraraka.png',
    heroImage: 'https://i.ibb.co/7jXq2gq/Uraraka.png',
    color: 'text-pink-400',
    sound: 'https://assets.mixkit.co/active_storage/sfx/2568/2568-preview.m4a',
  ...
  },
  {
    ...
    heroName: 'All Might',
    quirk: 'One For All',
    affiliation: 'Pro Hero (Retired)',
    birthday: 'June 10',
    height: '220 cm',
    bloodType: 'A',
    description: "The former No. 1 Hero and the 'Symbol of Peace'. He passed his Quirk, One For All, to Izuku Midoriya to be his successor.",
    stats: { power: 'S', speed: 'S', technique: 'S', intelligence: 'S', cooperativeness: 'S' },
    civilianImage: 'https://i.ibb.co/Y4mSbpt6/Adobe-Express-file.png',
    heroImage: 'https://i.ibb.co/Y4mSbpt6/Adobe-Express-file.png',
    color: 'text-yellow-500',
    sound: 'https://assets.mixkit.co/active_storage/sfx/1699/1699-preview.m4a',
    lightningColor: '#eab308'
  }
];